const resetPasswordTemplate = function (token: string, name: string) {
  const html = `
    <!DOCTYPE html>
...
<body
  ...
  <div style="display: none;">A request to reset password was received from your CuBuild Account</div>
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="margin: 0 0 24px;">
                        This is the password reset OTP you requested from CuBuild. Use to reset your CuBuild account password.
                      </p>
                      ...
                      <p style="margin: 0 0 16px;">
                        ...
                        <a href="mailto:ma5louf@codegate.info" class="hover-underline"
                          style="--text-opacity: 1; color: #7367f0; text-decoration: none;">ma5louf@codegate.info</a>.
                      </p>
                    </td>
                  </tr>
                  <tr>
  ...
  const text = `
        Reset Password, You recently requested to reset your password for your CuBuild account. Copy and paste it for reset password:
        ${token}
